...
class Movie(models.Model):
    ...
    world_premiere = models.DateField('Премьеры в мире', default=datetime.date.today)
...
class MovieShots(models.Model):
    ...
    movie = models.ForeignKey(Movie, verbose_name='Фильм', on_delete=models.CASCADE) # - при удалении фильма -
                                                                                     # при аттрибуте CASCADE все -
                                                                                     # кадры из фильма тоже удаляться
    def __str__(self):
        return self.title
